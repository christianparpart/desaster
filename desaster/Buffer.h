#ifndef desaster_Buffer_h
#define desaster_Buffer_h
...
public:
	...
	bool setCapacity(std::size_t value);
...
inline bool operator==(const Buffer& a, const char *b)
{
	return equals(a, b);
}
